...
>>>>>>> origin/master
	...
	~pokluda_v(){}
      ...
      struct pokluda_NP : EmissivityBase {
	pokluda_NP(ProblemSpecP db_model){
	  ProblemSpecP db_root = db_model->getRootNode();
	  Nenv = ArchesCore::get_num_env( db_root, ArchesCore::DQMOM_METHOD );
	  CoalHelper& coal_helper = CoalHelper::self();
	  std::string ash_type;
	  ...
	  B = coal_helper.get_coal_db().visc_activation_energy;
	  if (A==-999 || B==-999){
	    throw ProblemSetupException("Error: PokludaNP requires specification of ash viscosity parameters.", __FILE__, __LINE__);
	  }
	  if (ash_type == "indonesian"){
	    emiss_coeff = {0.79122357, -0.92666935, 0.36869062, 0.03126905, -0.04779213, -0.01066686, 0.04006169, -0.04087431, 0.01675401, -0.00426543, 0.00143633, 0.05299203, -0.18887178, 0.14076333, -0.01024888, -0.01109789, 0.00372919, 0.00475944, -0.00549589, 0.00034090, -0.00713212, 0.01421091, -0.00770291, 0.00166552, -0.00019683, 0.58351334, 0.00091646, 0.00654188};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 9.09195308e-01;
	    ystd = 9.22556402e-02;
	    surfT = {5.76298174e-01,-7.75639554e-05};
	    pokluda={-9.77629668e-01, 9.89316393e+00};
	    fresnel={9.55449126e-01, -3.43946648e-06, -1.28330213e-01, -4.59387549e-03};
	  } else if (ash_type == "german_lignite"){ // northD lignite
	    emiss_coeff = {0.80116394, -0.92548962, 0.36676451, 0.02692108, -0.04719084, 0.02276187, -0.01939856, -0.00948459, 0.01727716, -0.00821647, 0.00224623, 0.04658043, -0.18668947, 0.14458601, -0.00803464, -0.01352800, -0.00651216, 0.01769595, -0.00715344, -0.00106258, -0.00535150, 0.01308570, -0.00771603, 0.00283918, -0.00105693, 0.58377551, 0.00091089, 0.00749480};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 9.08025453e-01;
	    ystd = 9.26808211e-02;
	    surfT = {5.66739548e-01,-8.05189467e-05};
	    pokluda={-9.06641645e-01, 8.64865702e+00};
	    fresnel={9.53961515e-01, -2.60521295e-06, -1.19113964e-01, -4.16824607e-03};
	  } else if(ash_type == "lignite_german"){ // German lignite
	    emiss_coeff = {0.25735102, -0.60810134, 0.60426213, -0.21391614, -0.04252196, 0.00765696, -0.11620309, 0.12567120, -0.03876639, -0.00478974, 0.00321608, -0.01664762, -0.08827073, 0.12748150, -0.02978384, -0.00575821, -0.00759361, 0.03371343, -0.01927998, 0.00107923, 0.00383274, 0.00630163, -0.00784180, 0.00276815, -0.00235647, 0.54507949, 0.00031907, 0.03136241};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 9.44905843e-01;
	    ystd = 5.58087229e-02;
	    surfT = {7.87649117e-01,-1.58436191e-04};
	    pokluda={4.80439191e-01, 9.18774838e+00};
	    fresnel={9.30988744e-01, -4.39929358e-06, -8.66028263e-02, -8.57700680e-03};
	  }else if (ash_type == "sufco"){
	    emiss_coeff = {1.02054909, -0.91853525, 0.22159234, 0.08021331, -0.03409621, 0.00672312, 0.04582730, -0.04362211, 0.00983377, -0.00371224, 0.00296230, 0.08402144, -0.21931839, 0.12917982, 0.00630717, -0.01509430, 0.00045175, 0.00458622, -0.00346652, 0.00028689, -0.00951145, 0.01423642, -0.00625474, 0.00151975, -0.00027267, 0.54414491, 0.00083961, 0.00060301};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 8.82484492e-01;
	    ystd = 1.10691543e-01;
	    surfT = {4.98899377e-01,-4.78400649e-05};
	    pokluda={-1.24391097e+00, 8.81752311e+00};
	    fresnel={9.57497709e-01, -2.00805517e-06, -1.47174726e-01, -3.59647837e-03};
	  } else if (ash_type == "black_thunder"){
	    emiss_coeff = {0.96053297, -0.92314584, 0.25273163, 0.07483576, -0.03643441, -0.02779186, 0.08908253, -0.05926854, 0.00348092, 0.00044587, 0.00239370, 0.08360850, -0.21047229, 0.12456411, 0.00201521, -0.01198372, 0.00847173, -0.00477014, -0.00463660, 0.00246837, -0.01001721, 0.01437287, -0.00638375, 0.00084898, 0.00023773, 0.55308130, 0.00083834, 0.00048185};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
...
>>>>>>> origin/master
	    ...
	    emiss_coeff = {0.93420925, -0.92760605, 0.27114129, 0.06859793, -0.03730954, -0.00464945, 0.04651149, -0.04518810, 0.00696356, 0.00044745, 0.00146714, 0.07888429, -0.20351159, 0.12395999, 0.00183594, -0.01212495, -0.00062280, 0.00298001, -0.00580114, 0.00228523, -0.00910068, 0.01313615, -0.00610859, 0.00198094, -0.00037717, 0.55835866, 0.00089975, 0.00094979};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 8.93185265e-01;
	    ystd = 1.03603679e-01;
	    surfT = {6.63743742e-01,-1.01194510e-04};
	    pokluda={6.01022212e-02, 9.40458444e+00};
	    fresnel={9.52909019e-01, -3.00001667e-06, -1.11809051e-01, -4.79127810e-03};
	  } else if (ash_type == "illinois_no6"){
	    emiss_coeff = {0.73012183, -0.91998869, 0.41380604, 0.00703665, -0.05210143, 0.01175650, 0.00072765, -0.02027380, 0.02627312, -0.01083314, 0.00192675, 0.03236749, -0.18427400, 0.15669387, -0.01594555, -0.01269426, 0.00150171, 0.01404150, -0.00566189, -0.00240694, -0.00505668, 0.01504275, -0.00893893, 0.00187621, -0.00046723, 0.59610137, 0.00092856, 0.01039975};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
	    ymean = 9.15399456e-01;
	    ystd = 8.67769304e-02;
	    surfT = {4.20926724e-01,-2.37563806e-05};
	    pokluda={-1.68305054e+00, 8.47641506e+00};
	    fresnel={9.56483248e-01, -2.87592874e-06, -1.45389142e-01, -3.79667897e-03};
	  } else if (ash_type == "polish_coal"){ // Change, maybe??
	    emiss_coeff = {0.48614013, -0.52506995, 0.67895992, -0.46501249, 0.13443785, -0.05815506, -0.08908543, 0.15646069, 0.23721181, -0.34574423, 0.10183021, 0.06647438, -0.07050489, 0.08788616, -0.07187695, 0.01902046, -0.04944071, 0.04988776, -0.02755827, 0.00713287, 0.01706380, -0.00479225, 0.00217505, 0.01252978, -0.00357129, 0.58671155, -0.00761589, -0.01163714};
	    xmean = {9.50000000e+02, 1.66304348e-04};
	    xstd = {4.15013986e+02, 1.63118380e-04};
	    ymean = 7.03899649e-01;
...
>>>>>>> origin/master
	    ...
	    emiss_coeff = {0.61050770, -0.82218190, 0.44551783, -0.04496255, -0.04877452, 0.07069548, -0.13342373, 0.10384462, -0.03819942, -0.00866887, 0.00820056, 0.02826046, -0.13380812, 0.10361271, 0.00060603, -0.01165454, -0.02787842, 0.03235786, -0.00996634, -0.00033662, -0.00185722, 0.00852753, -0.00603064, 0.00507143, -0.00221416, 0.57756240, 0.00087462, 0.01496233};
	    xmean = {6.99992360e+00, -8.84951813e+00};
	    xstd = {5.50448260e-01, 1.86569621e+00};
...
>>>>>>> origin/master
	  ...
	  for(int env = 0; env != Nenv; env++) {
	    ...
	    //First obtain the volume, viscosity and surface tension for each environment
	    p_volume = M_PI/6.*Dp_vec[env]*Dp_vec[env]*Dp_vec[env]; // particle volme [m^3]
	    visc = 0.1*std::exp(std::log(T) + 1000.0*B/T + lnA); // kg / m / s
	    surface_tension = surfT[0] + surfT[1]*T; // kg / s^2
	    // Obtain the maximum sintering time [s] and the number of particles [#]
	    tmax = 1000*(0.5*Dp_vec[env])*visc/surface_tension;
	    NP = std::max(2.0,tau*vdot[env]/p_volume); // can't go below 2 particles
	    //std::cout <<"NP: " << NP << std::endl;
	    // Obtain the sintering stage
	    stage = std::min(std::max(1.,tau/tmax),std::log10(NP)/std::log10(2));
	    // Obtain the arrival size for the previous stage
	    rast = (0.5*Dp_vec[env])*std::exp2((stage - 1)/3);
...
>>>>>>> origin/master
	    ...
	    SArea = smin + 0.5*(smax - smin)*std::erfc((log10tau-pokluda[0])/(std::sqrt(2.)*pokluda[1]));
	    Sf = SArea*NP*std::exp2(-stage);
