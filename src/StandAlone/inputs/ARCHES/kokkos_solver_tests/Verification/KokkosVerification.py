...
<<<<<<< HEAD:src/StandAlone/inputs/ARCHES/kokkos_solver_tests/Verification/GridIndStudyTemp.py
  #print('variables '+myvars) 
=======

>>>>>>> origin/master:src/StandAlone/inputs/ARCHES/kokkos_solver_tests/Verification/KokkosVerification.py
